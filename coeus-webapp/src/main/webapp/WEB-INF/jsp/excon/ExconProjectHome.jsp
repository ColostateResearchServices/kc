...
<%@ include file="/WEB-INF/jsp/kraExconTldHeader.jsp"%>
  ...
  <kul:documentPage
	...
	htmlFormAction="exconProjectHome"
...
<div align="right"><kul:help documentTypeName="ExconProjectDocument" pageName="Project" /></div>
<%--
<kul:documentOverview editingMode="${KualiForm.editingMode}" />
--%>
<kra-excon:exconBasicInfo />
<kra-excon:exconProjectAssociatedDocuments />
