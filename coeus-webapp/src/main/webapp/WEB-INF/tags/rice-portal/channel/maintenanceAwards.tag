...
<div class="body">
  <ul class="chan">
    ...
    <c:if test="${financialIntegration}">
    	<li><portal:portalLink displayTitle="true" title="Award LOC Fund" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.cgb.LetterOfCreditFund&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
