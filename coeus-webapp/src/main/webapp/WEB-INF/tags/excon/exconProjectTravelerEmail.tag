...
<kul:tab tabTitle="Traveler Communication" defaultOpen="${isTravel}">
	<c:if test="${isTravel}" >
		<div class="tab-container" align="center">
			...
			<table cellpadding="0" cellspacing="0" summary="">
				...
				<c:if test="${traveler != null}">
					<tr style="background-color:#CCFFCC">
						...
						<th><div style="text-align:center">Unit</div></th>
					</tr>
					<tr>
			...
			<table cellpadding="0" cellspacing="0" summary="">
				<tr style="background-color:#CCFFCC">
					<th><div style="text-align:center">Destination Country</div></th>
					<th><div style="text-align:center">Arrival Date</div></th>
					<th><div style="text-align:center">Departure Date</div></th>
					<th><div style="text-align:center">Sanction List</div></th>
					<th><div style="text-align:center">Comment</div></th>
				</tr>
			...
			<table cellpadding="0" cellspacing="0">
				<tr style="background-color:#CCFFCC">
					<th width="25%"><div style="text-align:center">Communication Date</div></th>
					<th width="50%"><div style="text-align:center">Content/Agenda</div></th>
					<th><div style="text-align:center">Comment</div></th>
				</tr>
