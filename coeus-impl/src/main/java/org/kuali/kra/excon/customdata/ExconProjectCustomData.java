...
/**
 * This class is the BO representation of an Excon Custom Data.
 */
public class ExconProjectCustomData extends ExconProjectAssociate implements DocumentCustomData {
    ...
    private Long exconProjectCustomDataId;
...
//	}
    ...
    /**
     * Gets the exconProjectCustomDataId attribute. 
     * @return Returns the exconProjectCustomDataId.
     */
    public Long getExconProjectCustomDataId() {
        return exconProjectCustomDataId;
    }

    /**
     * Sets the exconProjectCustomDataId attribute value.
     * @param exconProjectCustomDataId The exconProjectCustomDataId to set.
     */
    public void setExconProjectCustomDataId(Long exconProjectCustomDataId) {
        this.exconProjectCustomDataId = exconProjectCustomDataId;
    }
    ...
    public void resetPersistenceState() {
        this.exconProjectCustomDataId = null;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((exconProjectCustomDataId == null) ? 0 : exconProjectCustomDataId.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        ExconProjectCustomData other = (ExconProjectCustomData) obj;
        if (exconProjectCustomDataId == null) {
            if (other.exconProjectCustomDataId != null) return false;
        } else if (!exconProjectCustomDataId.equals(other.exconProjectCustomDataId)) return false;
