...
/**
 * This class is for ExconProjectCustomDataAction...
 */
public class ExconProjectCustomDataAction extends ExconProjectAction {
    ...
    public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (new CustomDataRule().processRules(new SaveCustomDataEvent(exconProjectForm.getExconProjectDocument()))) {
