...
public abstract class CustomDataHelperBase<T extends DocumentCustomData> implements Serializable {
   ...
   protected CustomAttributeService getCustomAttributeService() {
    ...
    /** UITSRA-3358 - Add Sort ID to Custom Attribute Document Maintenance Document */
    /**
     *
     ...
     *    organized by sort ID. Then list the ones without a SORT_ID after in alphabetical order.
     *
     */
    public class SortIdComparator implements Comparator<CustomAttributeDocument> {
