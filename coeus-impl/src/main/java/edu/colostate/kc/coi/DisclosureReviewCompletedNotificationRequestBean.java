...
import org.kuali.kra.coi.notification.CoiNotificationRequestBean;
import org.kuali.kra.infrastructure.Constants;

import edu.colostate.kc.infrastructure.CSUKeyConstants;

public class DisclosureReviewCompletedNotificationRequestBean extends CoiNotificationRequestBean {
    ...
    public DisclosureReviewCompletedNotificationRequestBean(CoiDisclosure coiDisclosure, List<CoiUserRole> coiDisclosureReviewers) {
        super(coiDisclosure, CSUKeyConstants.DISCLOSURE_REVIEW_COMPLETED_NOTIFICATION, "Disclosure Review Completed");        
