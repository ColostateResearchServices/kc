...
//UITSRA-3668
public class IUNegotiationAwardReceivedNotificationContext extends NotificationContextBase {
    
    private static final long serialVersionUID = 70308097840555646L;
    private static final String NEGOTIATION_NOTIFICATION_MODULE_CODE = "5";
    private static final String NEGOTIATION_AWARD_RECEIVED_NOTIFICATION_ACTION_CODE = "500";
    
    private NegotiationDocument negotiationDocument;
    private List<EmailAttachment> emailAttachments;
    
    private IUNegotiationAwardReceivedNotificationContext(IUNegotiationNotificationRenderer renderer) {
        super(renderer);
    }
    
    public IUNegotiationAwardReceivedNotificationContext(NegotiationDocument negotiationDocument) {
        this(new IUNegotiationNotificationRenderer(negotiationDocument.getNegotiation()));
    ...
    public String getActionTypeCode() {
        return NEGOTIATION_AWARD_RECEIVED_NOTIFICATION_ACTION_CODE;
    }
